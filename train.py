...
def train_step(real_a, real_b, gen_a, gen_b, disc_a, disc_b):
    ...
    generator_a_optimizer.apply_gradients(zip(generator_b_gradients,
                                              gen_b.trainable_variables))

    discriminator_a_optimizer.apply_gradients(zip(discriminator_a_gradients,
                                                  disc_a.trainable_variables))

    discriminator_b_optimizer.apply_gradients(zip(discriminator_a_gradients,
                                                  disc_a.trainable_variables))
